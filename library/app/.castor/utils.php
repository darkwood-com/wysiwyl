...
function create_default_context(): Context
{
    ...
    if (file_exists($data['root_dir'] . '/tools/env/docker-compose.override.yml')) {
...
function docker_compose(array $subCommand, Context $c = null, bool $withBuilder = false): Process
{
    ...
    foreach (variable('docker_compose_files') as $file) {
        $command[] = '-f';
        $command[] = variable('root_dir') . '/tools/env/' . $file;
    }
    if ($withBuilder) {
        $command[] = '-f';
        $command[] = variable('root_dir') . '/tools/env/docker-compose.builder.yml';
    }
